...
const HeroSection = () => (
  <section className="relative overflow-hidden px-4 pt-24 pb-20 text-center md:pt-36 md:pb-28">
    ...
    >
      ...
      <motion.div
        ...
        className="mb-8 inline-flex items-center gap-2 rounded-full border border-primary/20 bg-card/60 backdrop-blur-md px-5 py-2.5 text-sm font-medium text-primary shadow-sm"
      >
      ...
      {/* Title */}
      <h1 className="mb-5 text-5xl font-extrabold tracking-tight md:text-7xl lg:text-8xl">
      ...
      <motion.div
        ...
        className="mt-10 flex items-center justify-center gap-1.5 text-xs font-medium tracking-wide uppercase text-muted-foreground/60"
      >
